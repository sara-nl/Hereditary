...
if __name__ == "__main__":
    trainset_for_this_client = federated_ox_flowers.load_partition(0, "train")

    trainset = trainset_for_this_client.with_transform(apply_transforms)

    client = FedViTClient(trainset)
    flwr.client.start_client(server_address="84.85.31.118:8080", client=client.to_client())