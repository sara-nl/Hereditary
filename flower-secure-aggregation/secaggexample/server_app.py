...
from secaggexample.task import get_weights, load_cifar10_test, make_net, set_weights, test
...
def main(grid: Grid, context: Context) -> None:
    ...
    log_dir = f"runs/{run_name}_{timestamp}" if run_name else f"runs/secagg_server_{timestamp}"
